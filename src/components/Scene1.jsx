...
export default function Scene1() {
  ...
  return (
    <section className="scene relative flex items-center justify-center" style={{
      ...
      <div className="relative z-10 text-center px-8 max-w-6xl">
        ...
        >
          <h1 className="text-8xl md:text-9xl font-bold text-[#ffb347] glitch text-glow mb-8">
            MAKEATHON 2025
          </h1>
        </motion.div>
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-[#d2c7a3] mb-12">
        ...
        >
          <p className="text-xl md:text-2xl text-[#d2c7a3] leading-relaxed font-light max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <div className="text-sm text-[#d2c7a3]/60 uppercase tracking-widest">
            Scroll to survive
          </div>
